...
<div>
    ...
    <div id="toolbar" v-if="showToolbar" :style="isExpanded ? 'display:block' : 'display:none'">
        ...
        <div class="btn-group offset-right">
            <button type="button" :disabled="selected_files.length == 0" v-if="allowUpload && hidden_element && allowMultiSelect" class="btn btn-default" v-on:click="addSelectedFiles()">
                <i class="voyager-upload"></i>
