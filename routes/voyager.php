...
Route::group(['as' => 'voyager.'], function () {
    ...
    Route::group(['middleware' => 'admin.user'], function () use ($namespacePrefix) {
        ...
        Route::group([
            ...
            Route::post('create_custom', ['uses' => $namespacePrefix.'VoyagerBreadController@createCustom',  'as' => 'create_custom']);
            Route::post('/', ['uses' => $namespacePrefix.'VoyagerBreadController@store',   'as' => 'store']);
            Route::get('{slug}/edit', ['uses' => $namespacePrefix.'VoyagerBreadController@edit', 'as' => 'edit']);
            ...
            Route::get('create_seeder/{slug}', ['uses' => $namespacePrefix.'VoyagerBreadController@createSeeder',  'as' => 'create_seeder']);
        ...
        Route::get('control_panel',$namespacePrefix.'VoyagerControlPanelController@controlPanel')->name('control_panel');
        Route::get('clear_cache',  $namespacePrefix.'VoyagerControlPanelController@clearCache');
        Route::group(['prefix' => 'ajax','as'=>'ajax.'],function()  use ($namespacePrefix) {
            Route::post('clear_cache', $namespacePrefix.'VoyagerControlPanelController@clearCache')->name('clear_cache');
        });
