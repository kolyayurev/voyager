...
return [
    ...
    'default_widget_search_key' => 'Поле server-side (widgets) поиска по умолчанию',
    'default_widget_search_key_ph' => 'Это поле будет изначально выбрано для поиска на странице редактирования виджета',
    ...
    'error_creating_seeder'  => 'Похоже, возникла проблема с созданием seeder',
    ...
    'per_page'               => 'Per page',
    'per_page_ph'            => 'Действует только при пагинации на строне сервера',
